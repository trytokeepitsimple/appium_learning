...
desired_caps['appPackage']='com.rove.develop'
...
#conf_file = '/home/devesh-ssd/PycharmProjects/appium_testing/device_conf/config.json'
...
print("app launched with desired capabilities")
