...
import sys
sys.path.append('/home/devesh-ssd/PycharmProjects/appium_testing/utilities/')
from utilities.generate_logs import log_creation




#defining fixture of failure
@pytest.fixture()
def log_on_failure(request):
    yield
    item = request.node
    if item.rep_call.failed:
        allure.attach(driver.get_screenshot_as_png(), name='screenshot1_1', attachment_type=AttachmentType.PNG)
...
def test_one():
    ...
    # #allure.attach(driver.get_screenshot_as_png(), name='screenshot5', attachment_type=AttachmentType.PNG)
